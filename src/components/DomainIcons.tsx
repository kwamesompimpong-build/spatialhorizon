import { DomainLayer } from "@/data/types";

export function getDomainIcon(domain: DomainLayer) {
  switch (domain) {
    case "Space":
      return (
